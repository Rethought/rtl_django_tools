...
class BasicUserCreationForm(forms.ModelForm):
    ...
    Copy/modify of the django.contrib.auth.forms.UserCreationForm
    """
    error_messages = {
...
class BasicUserChangeForm(forms.ModelForm):
    """
    Copy/modify of the django.contrib.auth.forms.UserChangeForm
    """
    email = forms.EmailField(label=_("Email"), max_length=254,
                             help_text=_("Required."),
    ...
    def __init__(self, *args, **kwargs):
        super(BasicUserChangeForm, self).__init__(*args, **kwargs)
